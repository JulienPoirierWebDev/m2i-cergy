...
function App() {
    ...
    <>
     ...
     <div className="relative flex justify-center items-center w-screen h-screen bg-[url(/home.png)] bg-cover">
        <div className="flex flex-col justify-center items-center">
          ...
          <a className="bg-customRgb p-5 text-white font-bold w-5/12 text-center rounded-lg ml-10 mt-12">
            EXPLORE
          </a>
        </div>

        <div className="border-1 absolute bg-white  flex flex-col -bottom-12 rounded-lg p-6 w-9/12" >
  ...
  <div className='w-1/2 p-2'>
    <img className="h-[500px] w-[600px]   m-10 " src={Appart1} alt="Appart1" />
    <p className='font-bold text-white relative bottom-64 left-56 text-2xl'> Standard Twin Room </p>
    <a className='bg-customRgb rounded-lg p-5 text-white relative bottom-52 left-64'>
      Check Rates
    </a>
  </div>
  <div className='w-1/2 p-2'> 
    <img className="h-[500px] w-[600px]  m-10 " src={Appart2} alt="Appart1" />
    <p className='font-bold text-white relative bottom-64 left-64 ml-2 text-2xl'> Standard Room </p>
  ...
  <div className='w-1/2 p-2'>
    <img className="h-[500px] w-[600px] m-10 " src={Appart1} alt="Appart1" />
    <p className='font-bold text-white relative bottom-64 left-52 text-2xl'> Standard View Room </p>
    <a className='bg-customRgb rounded-lg p-5 text-white relative bottom-52 left-64'>
      Check Rates
    </a>
  </div>
  <div className='w-1/2 p-2'>
    ...
    <img className='h-[500px] w-[600px] m-10 ' src={Appart2} alt="Appart1" />
    <p className='font-bold text-white relative bottom-64 left-64 ml-5 text-2xl'> Deluxe Room </p>
    <a className='bg-customRgb rounded-lg p-5 text-white relative bottom-52 left-72'>
      Check Rates
    </a>
...
<footer className='mt-10 h-[450px] bg-black'>
  ...
  <strong>Bon Hotels Head Office </strong> <br/> +27 434 344 432 <br/> info@bonhotels.com
  </p>
  ...
  <p className='text-white relative left-64 bottom-96 text-2xl mb-15 '> Subcribe for Offers</p>
  <input className='bg-white relative bottom-80 mb-3 left-16 p-2 w-2/12 rounded-lg'  placeholder='Email Address '/>
